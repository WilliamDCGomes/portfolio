...
import 'package:william_portifolio/utils/stylePages/app_colors.dart';
        ...
        SizedBox(
          ...
          child: Stack(
            children: [
              Center(
                child: Container(
                  width: ScreenSizeHelper.w(widget.constraints, 80),
                  margin: EdgeInsets.only(bottom: ScreenSizeHelper.h(widget.constraints, 15)),
                  ...
                  child: ListView(
                    ...
                    children: [
                      TextWebWidget(
                        ...
                        fontSize: ScreenSizeHelper.sp(widget.constraints, 40),
                        maxLines: 4,
                          ...
                          SizedBox(
                            ...
                            child: CarouselSlider.builder(
                              ...
                              options: CarouselOptions(
                                viewportFraction: ScreenSizeHelper.myToolsIconsShowing(widget.constraints, 18),
                                autoPlay: true,
                                height: ScreenSizeHelper.h(widget.constraints, 15),
