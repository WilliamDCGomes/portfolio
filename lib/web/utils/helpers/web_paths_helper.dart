class WebPathsHelper{
  ...
  static const String homeBackgroundRight = "${imagesPath}home_background_right.png";
  static const String logo = "${imagesPath}logo.png";
  static const String brazilFlag = "${imagesPath}brazil_flag.png";
  static const String instagramIcon = "${imagesPath}instagram_icon.png";
  static const String youtubeIcon = "${imagesPath}youtube_icon.png";
  static const String tiktokIcon = "${imagesPath}tiktok_icon.png";
  static const String linkedinIcon = "${imagesPath}linkedin_icon.png";
  static const String githubIcon = "${imagesPath}github_icon.png";
  static const String gmailIcon = "${imagesPath}gmail_icon.png";
  static const String resumeIcon = "${imagesPath}resume_icon.png";
  static const String flutterIcon = "${imagesPath}flutter_icon.png";
  static const String dartIcon = "${imagesPath}dart_icon.png";
  static const String xamarinFormsIcon = "${imagesPath}xamarin_forms_icon.png";
  static const String mauiIcon = "${imagesPath}maui_icon.png";
  static const String cSharpIcon = "${imagesPath}c#_icon.png";
  static const String dotNetIcon = "$imagesPath.net_icon.png";
  static const String swiftIcon = "${imagesPath}swift_icon.png";
  static const String htmlIcon = "${imagesPath}html_icon.png";
  static const String cssIcon = "${imagesPath}css_icon.png";
  static const String jsIcon = "${imagesPath}js_icon.png";
  static const String tsIcon = "${imagesPath}ts_icon.png";
  static const String angularIcon = "${imagesPath}angular_icon.png";
  static const String sqlServerIcon = "${imagesPath}sql_server_icon.png";
  static const String sqliteIcon = "${imagesPath}sqlite_icon.png";
  static const String postgresqlIcon = "${imagesPath}postgresql_icon.png";
  static const String mysqlIcon = "${imagesPath}mysql_icon.png";
  static const String azureIcon = "${imagesPath}azure_icon.png";
  static const String firebaseIcon = "${imagesPath}firebase_icon.png";
